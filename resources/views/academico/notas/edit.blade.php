        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('academico.notas.update', $nota) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="asignatura" id="asignatura" value="{{ old('asignatura') ?? $nota->asignatura }}" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500" required>
                            @error('asignatura')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="calificacion" id="calificacion" min="0" max="20" step="0.01" value="{{ old('calificacion') ?? $nota->calificacion }}" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500" required>
                            @error('calificacion')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="periodo" id="periodo" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500" required>
                                ...
                                <option value="Primer Lapso" {{ (old('periodo') ?? $nota->periodo) == 'Primer Lapso' ? 'selected' : '' }}>Primer Lapso</option>
                                <option value="Segundo Lapso" {{ (old('periodo') ?? $nota->periodo) == 'Segundo Lapso' ? 'selected' : '' }}>Segundo Lapso</option>
                                <option value="Tercer Lapso" {{ (old('periodo') ?? $nota->periodo) == 'Tercer Lapso' ? 'selected' : '' }}>Tercer Lapso</option>
                                <option value="Final" {{ (old('periodo') ?? $nota->periodo) == 'Final' ? 'selected' : '' }}>Final</option>
                            </select>
                            @error('periodo')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="fecha" id="fecha" value="{{ old('fecha') ?? $nota->fecha->format('Y-m-d') }}" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500" required>
                            @error('fecha')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="observaciones" id="observaciones" rows="3" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500">{{ old('observaciones') ?? $nota->observaciones }}</textarea>
                            @error('observaciones')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
